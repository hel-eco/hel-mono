...
module.exports = function (webpackEnv) {
  ...
  const devtoolVal = shouldUseSourceMap ? 'source-map' : false;
  return {
    target: ['browserslist'],
    ...
    devtool: isEnvProduction ? devtoolVal : isEnvDevelopment && 'cheap-module-source-map',
          ...
          oneOf: [
            ...
            },
            {
              ...
              use: getStyleLoaders(
                ...
                options: {
                  lessOptions: { // This is where you put Less specific options
      ...
      new WebpackManifestPlugin({
        ...
        generate: (seed, files, entrypoints) => {
          const manifestFiles = files.reduce((manifest, file) => {
            const manifestVar = manifest;
            manifestVar[file.name] = file.path;
            return manifest;
          }, seed);
